...
"""
wlmetrics.py
Work life balance metric functions
...
# Metric 1 and 2: Weighted sum(life) - sum(work) normalized to (0,1)
...
# Metric 5: More than x hours work in the day
def w_l_balance_workday(df, workid='0501', hours=9):
